<template>
<section class="section"><div class="site-section overlay container" id="datenschutz" >
        <p><h1>Datenschutz</h1></p>
        ...
        <p>Bodybuilding-Company GmbH<br>Ricklinger Stadtweg 32<br>30459 Hannover</p>
        <p>Telefon: 0511-708 177 10<br>E-Mail:&nbsp;<a href="mailto:info@bodybuilding-company.de">info@bodybuilding-company.de</a></p>
        <p><strong>Vertreten durch die Geschäftsführenden Gesellschafter:</strong><br>Dominik Woywat<br>Roland Olbricht</p>
        <p>Link zum Impressum: <a href="https://www.bodybuilding-company.de/#impressum">https://www.bodybuilding-company.de/#impressum</a></p>
        ...
        <h4>Verlinkung Social-Media über Grafik oder Textlink</h4>
